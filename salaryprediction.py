...
model = pickle.load(open(r'E:\VS Code\pickle.py\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by pratik kulkarni")